...
export const VISIT_TRANSITIONS: VisitTransition[] = [
  ...
  { from: VisitStatus.ASSIGNED, to: VisitStatus.EN_ROUTE, allowedRoles: [Role.DOCTOR] },
  { from: VisitStatus.EN_ROUTE, to: VisitStatus.IN_PROGRESS, allowedRoles: [Role.DOCTOR] },
