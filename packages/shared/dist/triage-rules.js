...
exports.TRIAGE_MESSAGES = exports.ASSOCIATED_SIGN_QUESTIONS = exports.SEVERITY_LABELS = exports.SeverityOption = exports.DURATION_LABELS = exports.DurationOption = exports.SYMPTOM_CATEGORIES = exports.TRIAGE_TAXONOMY_NOTICE = exports.TRIAGE_RULE_VERSION = void 0;
...
function isSevere(symptom) {
    return symptom?.severity === exports.SeverityOption.SEVERE;
}
...
const RED_FLAG_RULES = [
    ...
    },
    {
        ...
        test: (a) => {
            ...
            if (!h)
                return false;
            return (sign(h, 'severe_sudden_headache') ||
    ...
    },
    {
        ...
        priority: 'RED',
        test: (a) => anySign(a, FALL_INJURY_IDS, 'head_injury') ||
...
const ORANGE_FLAG_RULES = [
    {
        ...
        priority: 'ORANGE',
        test: (a) => ['sudden_behaviour_change', 'new_confusion', 'new_weakness', 'caregiver_concern', 'reduced_mobility', 'difficulty_eating_drinking'].some((id) => !!findSymptom(a, id)),
    },
    {
    ...
    },
    {
        ...
        test: (a) => a.symptoms.some((s) => s.severity === exports.SeverityOption.SEVERE),
    },
];
