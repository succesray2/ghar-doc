...
export function Step1WhoNeedsCare({
  ...
  return (
    <div className="space-y-5">
      <h2 className="text-lg font-semibold text-slate-800">Who needs the doctor?</h2>
      ...
      {isSomeoneElse && (
        <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
          <p className="text-sm text-slate-600">A few details about who this visit is for, and how the doctor can reach you.</p>
