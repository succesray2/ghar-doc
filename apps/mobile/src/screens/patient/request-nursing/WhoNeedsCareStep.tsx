...
export function WhoNeedsCareStep({
  ...
  return (
    <View>
      <Text style={styles.title}>Who needs nursing care?</Text>
      ...
      {isSomeoneElse && (
        <View style={styles.subCard}>
          <Text style={styles.subCardHint}>A few details about who this visit is for, and how the nurse can reach you.</Text>
