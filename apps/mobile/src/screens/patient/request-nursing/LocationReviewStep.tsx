  ...
  return (
    <View>
      ...
      <View style={styles.summary}>
        ...
        <Text style={[styles.summaryLabel, styles.summarySpacer]}>SERVICE</Text>
        <Text style={styles.summaryValue}>{state.nursingServiceType ? NURSING_SERVICE_LABELS[state.nursingServiceType] : '—'}</Text>
      </View>
