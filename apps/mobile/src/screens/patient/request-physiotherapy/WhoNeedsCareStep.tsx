...
export function WhoNeedsCareStep({
  ...
  return (
    <View>
      <Text style={styles.title}>Who needs physiotherapy?</Text>
      ...
      {isSomeoneElse && (
        <View style={styles.subCard}>
          <Text style={styles.subCardHint}>A few details about who this visit is for, and how the physiotherapist can reach you.</Text>
