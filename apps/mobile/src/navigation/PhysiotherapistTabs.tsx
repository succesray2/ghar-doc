...
import { AssignedVisitsScreen } from '../screens/physiotherapist/AssignedVisitsScreen';
import { ProfileScreen } from '../screens/ProfileScreen';
import { colors } from '../theme/colors';
import type { PhysiotherapistTabParamList } from './types';

const Tab = createBottomTabNavigator<PhysiotherapistTabParamList>();

export function PhysiotherapistTabs() {
  return (
